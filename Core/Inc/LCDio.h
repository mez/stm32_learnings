...
void initialize_LCD_pins() {
    ...
    config_port_and_pin_for_output(LCDD2_PORT, LCDD2_PIN);
    config_port_and_pin_for_output(LCDD3_PORT, LCDD3_PIN);
    config_port_and_pin_for_output(LCDD4_PORT, LCDD4_PIN);
    config_port_and_pin_for_output(LCDD5_PORT, LCDD5_PIN);
    config_port_and_pin_for_output(LCDD6_PORT, LCDD6_PIN);
    config_port_and_pin_for_output(LCDD7_PORT, LCDD7_PIN);
    config_port_and_pin_for_output(LCDRegisterSelect_PORT, LCDRegisterSelect_PIN);
    config_port_and_pin_for_output(LCDReadWrite_PORT, LCDReadWrite_PIN);
